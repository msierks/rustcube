...
use rustcube::{cpu::spr::*, Event as ctxEvent};
...
impl Registers {
    pub fn new(ctx: &rustcube::Context) -> Self {
        ...
        let spr_32 = [
            ...
            ("SRR1", spr[SPR_SRR1]),
            ("SPRG0", spr[SPR_SPRG0]),
            ("SPRG1", spr[SPR_SPRG0 + 1]),
            ("SPRG2", spr[SPR_SPRG0 + 2]),
            ("SPRG3", spr[SPR_SPRG0 + 3]),
            ("EAR", spr[SPR_EAR]),
            ("PVR", spr[SPR_PVR]),
            ("GQR0", spr[SPR_GQR0]),
            ("GQR1", spr[SPR_GQR0 + 1]),
            ...
            ("MMCR0", spr[SPR_MMCR0]),
            ("MMCR1", spr[SPR_MMCR1]),
            ("UMMCR0", spr[SPR_UMMCR0]),
            ("UMMCR1", spr[SPR_UMMCR1]),
            ("UPMC1", spr[SPR_UPMC1]),
            ("UPMC2", spr[SPR_UPMC2]),
            ("UPMC3", spr[SPR_UPMC3]),
            ("UPMC4", spr[SPR_UPMC4]),
            ...
            ("ICTC", spr[SPR_ICTC]),
            ("THRM1", spr[SPR_THRM1]),
            ("THRM2", spr[SPR_THRM1 + 1]),
            ("THRM3", spr[SPR_THRM1 + 2]),
        ];
        let spr_64 = [
            ("TB", ((spr[SPR_TBU] as u64) << 32) | (spr[SPR_TBL] as u64)),
            (
                "IBAT0",
                ((spr[SPR_IBAT0U] as u64) << 32) | (spr[SPR_IBAT0L] as u64),
            ),
            (
                "IBAT1",
                ((spr[SPR_IBAT1U] as u64) << 32) | (spr[SPR_IBAT1L] as u64),
            ),
            (
                "IBAT2",
                ((spr[SPR_IBAT2U] as u64) << 32) | (spr[SPR_IBAT2L] as u64),
            ),
            (
                "IBAT3",
                ((spr[SPR_IBAT3U] as u64) << 32) | (spr[SPR_IBAT3L] as u64),
            ),
            (
                "DBAT0",
                ((spr[SPR_DBAT0U] as u64) << 32) | (spr[SPR_DBAT0L] as u64),
            ),
            (
                "DBAT1",
                ((spr[SPR_DBAT1U] as u64) << 32) | (spr[SPR_DBAT1L] as u64),
            ),
            (
                "DBAT2",
                ((spr[SPR_DBAT2U] as u64) << 32) | (spr[SPR_DBAT2L] as u64),
            ),
            (
                "DBAT3",
                ((spr[SPR_DBAT3U] as u64) << 32) | (spr[SPR_DBAT3L] as u64),
            ),
            (
                "DMA",
                ((spr[SPR_DMAU] as u64) << 32) | (spr[SPR_DMAU + 1] as u64),
            ),
        ];
