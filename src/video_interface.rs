...
impl VideoInterface {
    ...
    pub fn write_u16(&mut self, register: u32, val: u16) {
        match register {
            ...
            BURST_BLANKING_ODD_HI | BURST_BLANKING_ODD_LO | BURST_BLANKING_EVEN_HI | BURST_BLANKING_EVEN_LO | DISPLAY_INTERRUPT_0_HI |
            DISPLAY_INTERRUPT_0_LO | DISPLAY_INTERRUPT_1_HI | DISPLAY_INTERRUPT_1_LO | FILTER_COEFFICIENT_0_HI | FILTER_COEFFICIENT_0_LO |
            FILTER_COEFFICIENT_1_HI | FILTER_COEFFICIENT_1_LO | FILTER_COEFFICIENT_2_HI | FILTER_COEFFICIENT_2_LO | FILTER_COEFFICIENT_3_HI |
            FILTER_COEFFICIENT_3_LO | FILTER_COEFFICIENT_4_HI | FILTER_COEFFICIENT_4_LO | FILTER_COEFFICIENT_5_HI | FILTER_COEFFICIENT_5_LO |
            FILTER_COEFFICIENT_6_HI | FILTER_COEFFICIENT_6_LO | SCALING_WIDTH | UNKNOWN => {},
